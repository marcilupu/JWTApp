...
namespace AuthServer.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        [HttpPost("Login")]
        public IActionResult Login(LoginForm loginForm, [FromServices] IJwtManager jwtManager, [FromServices] UserRepository userRepository)
        {
            User? dbUser = userRepository.GetUser(loginForm.Username); //da null idk why
